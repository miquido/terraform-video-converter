...
| <a name="module_video-cdn"></a> [video-cdn](#module\_video-cdn) | git::git@github.com:cloudposse/terraform-aws-cloudfront-s3-cdn.git | tags/0.72.0 |
...
| <a name="input_execute-api-arn"></a> [execute-api-arn](#input\_execute-api-arn) | arn:aws:execute-api:var.aws\_region:var.aws\_used\_account\_no:* | `string` | n/a | yes |
| <a name="input_mediaconvert-arn"></a> [mediaconvert-arn](#input\_mediaconvert-arn) | arn:aws:mediaconvert:var.aws\_region:var.aws\_used\_account\_no:* | `string` | n/a | yes |
